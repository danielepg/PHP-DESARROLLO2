...
<h2 class="text-center">Tipo Maquina</h2>
</br>
    <a href="ingresotipomaquina.php" class="btn btn-primary">INGRESO TIPO MAQUINA</a>
    </br>
    </br>
    ...
    <div class="row">
        ...
        <tbody>
            <?php 
                ...
                <tr>
                    <td><?php echo $row['ID_TIPO_MAQUINA'] ?></td>
                    <td><?php echo $row['DESCRIPCION']  ?></td>
                    <td><?php echo $row['ESTATUS']  ?></td>                 
                    <td>

                    <div class="btn-group">
                    <a href="edittipomaquina.php?ID=<?php echo $row['ID_TIPO_MAQUINA']?>" class="btn btn-primary">
                        <i class="fas fa-marker"></i>
                        </a>
                        <a href="deletetipomaquina.php?ID=<?php echo $row['ID_TIPO_MAQUINA']?>" class="btn btn-danger">
